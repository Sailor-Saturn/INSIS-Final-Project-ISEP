...
public class FormalizationMapper {
    ...
    public static Formalization requestUpdateDtoToDomain(ResponseFormalizationDTO updateFormalizationDto){
        ...
        updateFormalization.setProposalId(updateFormalizationDto.getProposalId());
    ...
    public static ResponseFormalizationDTO domainToDto(Formalization formalization){
        ResponseFormalizationDTO formalizationDTO = new ResponseFormalizationDTO();
    ...
    public static List<ResponseFormalizationDTO> domainListToDtoList(List<Formalization> formalizationList) {

        List<ResponseFormalizationDTO> responseFormalizationList =  new LinkedList<>();
